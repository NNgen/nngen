...
The quantizer assumes that the input of every layer has the Gaussian
distribution. You can set min/max ranges of input values by the
value_range argument.
