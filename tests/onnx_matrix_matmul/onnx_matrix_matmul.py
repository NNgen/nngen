...
def run(act_shape=(1, 15), weight_shape=(13, 15), use_bias = False,
    ...
    # pytorch model
    layers = []
    layers.append(nn.Linear(weight_shape[1], weight_shape[0], bias = use_bias))
    ...
    # Pytorch to ONNX
    onnx_filename = 'onnx_matrix_matmul.onnx'
    ...
    targ = ng.to_veriloggen([out], 'onnx_matrix_matmul', silent=silent,
