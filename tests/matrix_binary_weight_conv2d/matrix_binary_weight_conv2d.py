...
def run(act_shape=(1, 7, 7, 7), weight_shape=(3, 3, 3, 7),
        ...
        act_dtype=ng.int32, weight_dtype=ng.uint1,
    ...
    out = ng.binary_weight_conv2d(act, weight, stride,
                                  bias, scale,
                                  rshift_mul, rshift_sum, rshift_out,
                                  act_func, 'SAME',
                                  out_dtype, ng.int32, ng.int32,
                                  'binary_weight_conv2d',
    ...
    targ = ng.to_veriloggen([out], 'matrix_binary_weight_conv2d', silent=silent,
    ...
    vweight = np.where(vweight > [0], vweight_ones, vweight_zeros)
    ...
    vout = ng.verify.binary_weight_conv2d(vact, vweight, stride,
                                          vbias, vscale,
                                          rshift_mul, rshift_sum, rshift_out,
                                          act_func, 'SAME',
                                          out_dtype, ng.int32, ng.int32,
