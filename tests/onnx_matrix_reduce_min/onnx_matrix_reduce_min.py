...
def run(act_shape=(15, 31),
    ...
    # pytorch model
    model = MatrixReduceMin()

    # Pytorch to ONNX
    onnx_filename = 'onnx_matrix_reduce_min.onnx'
    ...
    for op in operators.values():
        if isinstance(op, ng.reduce_min):
    ...
    targ = ng.to_veriloggen([out], 'onnx_matrix_reduce_min', silent=silent,
