...
def run(a_shape=(15, 15), b_shape=(15, 15),
    ...
    targ = ng.to_veriloggen([c], 'matrix_add_use_map_ram', silent=silent,
    ...
    size_check = size_max
    map_addr = check_addr + size_check
    size_map = 4096
    tmp_addr = map_addr + size_map
    ...
    def ctrl():
        ...
        ng.sim.set_global_addr_map(_saxi, memory, map_addr, tmp_addr, c.addr, a.addr, b.addr)
