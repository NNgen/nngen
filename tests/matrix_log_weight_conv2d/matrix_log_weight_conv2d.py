...
def run(act_shape=(1, 7, 7, 7), weight_shape=(3, 3, 3, 7),
        ...
        act_dtype=ng.int32, weight_dtype=ng.int4,
    ...
    out = ng.log_weight_conv2d(act, weight, stride,
                               bias, scale,
    ...
    targ = ng.to_veriloggen([out], 'matrix_log_weight_conv2d', silent=silent,
    ...
    vout = ng.verify.log_weight_conv2d(vact, vweight, stride,
                                       vbias, vscale,
                                       rshift_mul, rshift_sum, rshift_out,
                                       act_func, 'SAME',
                                       out_dtype, ng.int32, ng.int32,
