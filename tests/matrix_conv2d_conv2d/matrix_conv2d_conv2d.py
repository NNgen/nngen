...
def run(act_shape=(1, 7, 7, 15),
        ...
        rshift_sum1=None, rshift_out1=None,
        rshift_sum2=None, rshift_out2=None,
    ...
    targ = ng.to_veriloggen([out], 'matrix_conv2d_conv2d', silent=silent,
