...
def run(act_shape=(1, 4, 4, 3),
        weight0_shape=(9, 3, 3, 3), weight1_shape=(9, 36),
    ...
    # pytorch model
    layers = []
    layers.append(nn.Conv2d(weight0_shape[3], weight0_shape[0], weight0_shape[1],
                            stride=stride0, padding=padding0))
    ...
    # Pytorch to ONNX
    onnx_filename = 'onnx_matrix_conv2d_linear.onnx'
    ...
    targ = ng.to_veriloggen([out], 'onnx_matrix_conv2d_linear', silent=silent,
